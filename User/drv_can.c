...
void CAN_Init(CAN_HandleTypeDef *hcan, CAN_Call_Back Callback_Function)
{
    ...
    if (hcan->Instance == CAN1)
    {
        ...
        CAN_Filter_Mask_Config(hcan, CAN_FILTER(0) | CAN_FIFO_0 | CAN_STDID | CAN_DATA_TYPE, 0x006, 0x7ff);
        CAN_Filter_Mask_Config(hcan, CAN_FILTER(1) | CAN_FIFO_1 | CAN_STDID | CAN_DATA_TYPE, 0x007, 0x7ff);
    }
...
void TIM_CAN_PeriodElapsedCallback()
{
    ...
    // CAN2电机
    // CAN_Send_Data(&hcan2, 0x3fe, CAN2_0x3fe_Tx_Data, 8);
